...
import com.github.dan4ik95dv.famousartists.model.yandex.album.response.AlbumResponse;
import com.github.dan4ik95dv.famousartists.model.yandex.artist.response.ArtistResponse;
import com.github.dan4ik95dv.famousartists.model.yandex.genre.response.GenreResponse;
import com.github.dan4ik95dv.famousartists.model.yandex.mix.response.Mix;
import com.github.dan4ik95dv.famousartists.model.yandex.search.response.MusicSearchResponse;
import com.github.dan4ik95dv.famousartists.model.yandex.track.response.TrackResponse;
...
public interface RestMusic {

    //Get Artist
    @Headers({"Accept: application/json", "Content-Type: application / json"})
    @GET("artist.jsx")
    Observable<ArtistResponse> getArtist(@Query("artist") Integer artistId, @Query("lang") String lang, @Query("what") String type);

    //Search
    @Headers({"Accept: application/json", "Content-Type: application / json"})
    @GET("music-search.jsx")
    Observable<MusicSearchResponse> getQuery(@Query("text") String text, @Query("type") String type, @Query("lang") String lang, @Query("page") Integer pageOffset);

    //Get track
    @Headers({"Accept: application/json", "Content-Type: application / json"})
    @GET("track.jsx")
    Observable<TrackResponse> getTrack(@Query("track") Integer trackId, @Query("lang") String lang);

    //Get album
    @Headers({"Accept: application/json", "Content-Type: application / json"})
    @GET("album.jsx")
    Observable<AlbumResponse> getAlbum(@Query("album") Integer albumId, @Query("lang") String lang);

    //Get by genre
    @Headers({"Accept: application/json", "Content-Type: application / json"})
    @GET("genre.jsx")
    Observable<GenreResponse> getGenre(@Query("genre") String genre, @Query("filter") String filter, @Query("lang") String lang);

    //Get mix
    @Headers({"Accept: application/json", "Content-Type: application / json"})
    @GET("genre.jsx")
    Observable<Mix> getMix(@Query("id") String mixtype, @Query("lang") String lang);
