...
import com.github.dan4ik95dv.famousartists.model.yandex.album.response.Album;
import com.github.dan4ik95dv.famousartists.model.yandex.artist.response.Artist;
import com.github.dan4ik95dv.famousartists.model.yandex.search.response.MusicSearch;
import com.github.dan4ik95dv.famousartists.model.yandex.track.response.Track;
...
public interface RestMusic {
    ...
    @GET("artist.jsx")
    Observable<Artist> getArtist(@Query("artist") Integer artistId, @Query("lang") String lang, @Query("what") String type);

    //Search
    @Headers({"Accept: application/json", "Content-Type: application / json"})
    @GET("music-search.jsx")
    Observable<MusicSearch> getQuery(@Query("text") String text, @Query("type") String type, @Query("lang") String lang, @Query("page") Integer pageOffset);

    //Get track
    @Headers({"Accept: application/json", "Content-Type: application / json"})
    @GET("track.jsx")
    Observable<Track> getTrack(@Query("track") Integer trackId, @Query("lang") String lang);

    //Get album
    @Headers({"Accept: application/json", "Content-Type: application / json"})
    @GET("album.jsx")
    Observable<Album> getAlbum(@Query("album") Integer albumId, @Query("lang") String lang);
